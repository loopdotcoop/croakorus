if (Meteor.isServer) {
    Meteor.startup(function () {
        ...
        var i
          , x = xStart = Config.viewpoint.spawnX
          , z = zStart = Config.viewpoint.spawnZ + 10 // we start a little South of the spawn-point, and head Southwards from there
          , xmin = 99999
          , xmax = -99999
          , zmin = 99999
          , zmax = -99999
...
console.log(-2,xmin,xmax,zmin,zmax,markers);
            ...
            Tracks.insert({
              ...
              , start:   xStart + 'x' + zStart // @todo append '/a', '/b/', if this user already has a track starting at these coords
              , xmin:    xmin
              , xmax:    xmax
              , zmin:    zmin
              , zmax:    zmax
